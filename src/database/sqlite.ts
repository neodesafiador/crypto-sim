...
INSERT INTO Users (userID, email, passwordHash, balance)
VALUES
  (1, 'user1@example.com', 'abcdefg', 10000.00),
  (2, 'user2@example.com', 'hijklmn', 10000.00),
  (3, 'user3@example.com', 'opqrstu', 10000.00);
`;
